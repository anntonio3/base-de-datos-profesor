 ...
 * @author anton
 */
public class GestionCA extends javax.swing.JDialog {
    private InsertarCA ica;
    private ActualizarCA aca;

    /**
     * Creates new form GestionProfesor
     */
    public GestionCA(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ica=new InsertarCA(this,true);
        aca=new ActualizarCA(this,true);
       ...
       private void cargarDatosEnTabla (){
        try {
            ...
            List<CA> listaCa = caDAO.obtenerCA();
            
            DefaultTableModel model = (DefaultTableModel) visorCA.getModel();
    ...
    private void buscarCAPorID(int idCA) {
       
            CA_DAO caDAO = new CA_DAO();
            List<CA> listaCa = caDAO.buscarCAPorNombre(idCA);
    ...
    private void eliminarCA(int id) {
            CA_DAO caDAO = new CA_DAO();
            caDAO.eliminarCA(id);
    } 
    ...
    private void initComponents() {
        ...
        visorCA = new javax.swing.JTable();
        ...
        jLabel1.setText("Cuerpo academico");
        ...
        visorCA.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
            ...
            new String [] {
                "Id_CA", "Nombre_CA", "LGAC_asociada"
            }
        ));
        jScrollPane1.setViewportView(visorCA);
    ...
    private void btnEliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEliminarMouseClicked
        ...
        List<CA> ca = caDAO.buscarCAPorNombre(Integer.parseInt(txtDatoBusqueda.getText()));
        if (!ca.isEmpty()) {
            int id= Integer.parseInt(txtDatoBusqueda.getText());

            eliminarCA(id);
        } else {
            JOptionPane.showMessageDialog(this, "No se encontró ningún Cuerpo Academico");
        }
    ...
    private void btnBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnBuscarMouseClicked
        buscarCAPorID(Integer.parseInt(txtDatoBusqueda.getText()));

        CA_DAO caDAO = new CA_DAO();

        List<CA> cuerpoA = caDAO.buscarCAPorNombre(Integer.parseInt(txtDatoBusqueda.getText()));
        if (!cuerpoA.isEmpty()) {
            CA ca = cuerpoA.get(0); 
            aca.mostrarDatos(ca);
        } else {
    ...
    private javax.swing.JTable visorCA;

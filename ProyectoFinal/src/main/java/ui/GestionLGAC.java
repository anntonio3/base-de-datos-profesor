 ...
 * @author anton
 */
public class GestionLGAC extends javax.swing.JDialog {
    private InsertarLGAC ilgac;
    private ActualizarLGAC algac;

    /**
     * Creates new form GestionProfesor
     */
    public GestionLGAC(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ilgac=new InsertarLGAC(this,true);
        algac=new ActualizarLGAC(this,true);
       ...
       private void cargarDatosEnTabla (){
        try {
            ...
            List<LGAC> listaLgac = lgacDAO.obtenerLGAC();
            
            DefaultTableModel model = (DefaultTableModel) visorLGAC.getModel();
            model.setRowCount(0); //Limpiar el modelo
            
            for(LGAC lgac : listaLgac){
                model.addRow(new Object[]{
                    lgac.getId_LGAC(),
                    lgac.getNombre_LGAC(),
                    lgac.getNo_horas_semanas(),
                    lgac.getProfesor_CURP()});
            }
    ...
    private void buscarLGACPorID(int idCA) {
       
            LGAC_DAO lgacDAO = new LGAC_DAO();
            List<LGAC> listaLgac = lgacDAO.buscarLGACPorNombre(idCA);
            
            DefaultTableModel model = (DefaultTableModel) visorLGAC.getModel();
            model.setRowCount(0); // Limpiar el modelo
            
            for (LGAC l : listaLgac) {
                model.addRow(new Object[]{
                    l.getId_LGAC(),
                    l.getNombre_LGAC(),
                    l.getNo_horas_semanas(),
                    l.getProfesor_CURP()});
            }
        
    }
    
    private void eliminarLGAC(int id) {
            LGAC_DAO lgacDAO = new LGAC_DAO();
            lgacDAO.eliminarLGAC(id);
    } 
    ...
    private void initComponents() {
        ...
        visorLGAC = new javax.swing.JTable();
        ...
        visorLGAC.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
            ...
            new String [] {
                "Id_LGAC", "Nombre_LGAC", "No_horas_semana", "Profesor_CURP"
            }
        ));
        jScrollPane1.setViewportView(visorLGAC);
    ...
    private void btnEliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEliminarMouseClicked
        ...
        List<LGAC> lgac = lgacDAO.buscarLGACPorNombre(Integer.parseInt(txtDatoBusqueda.getText()));
        if (!lgac.isEmpty()) {
            int id= Integer.parseInt(txtDatoBusqueda.getText());

            eliminarLGAC(id);
        } else {
            JOptionPane.showMessageDialog(this, "No se encontró ningún LGAC");
        }
    }//GEN-LAST:event_btnEliminarMouseClicked

    private void btnInsertarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnInsertarMouseClicked
        ilgac.setLocationRelativeTo(null);
        ilgac.setVisible(true);
    ...
    private void btnActualizarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnActualizarMouseClicked
        ...
        List<LGAC> lgac = lgacDAO.buscarLGACPorNombre(Integer.parseInt(txtDatoBusqueda.getText()));
        if (!lgac.isEmpty()) {
            algac.setLocationRelativeTo(null);
            algac.setVisible(true);
        } else {
            JOptionPane.showMessageDialog(this, "No se encontró ningún LGAC");
        }
    ...
    private void btnBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnBuscarMouseClicked
        buscarLGACPorID(Integer.parseInt(txtDatoBusqueda.getText()));
    ...
    private javax.swing.JTable visorLGAC;

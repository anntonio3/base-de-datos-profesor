 ...
 * @author anton
 */
public class GestionDireccionIndividualizada extends javax.swing.JDialog {
    private InsertarDireccionIndividualizada idi;
    private ActualizarDireccionIndividualizada adi;

    /**
     * Creates new form GestionProfesor
     */
    public GestionDireccionIndividualizada(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        idi=new InsertarDireccionIndividualizada(this,true);
        adi=new ActualizarDireccionIndividualizada(this,true);
       ...
       private void cargarDatosEnTabla (){
        try {
            Direccion_individualizadaDAO direcIDAO = new Direccion_individualizadaDAO();
            List<Direccion_individualizada> listaDirecI = direcIDAO.obtenerDireccionIndividualizada();
            
            DefaultTableModel model = (DefaultTableModel) visorDireccionIndividualizada.getModel();
            model.setRowCount(0); //Limpiar el modelo
            
            for(Direccion_individualizada dI : listaDirecI){
    ...
    private void buscarDireccionIndividualizadaPorID(int id) {
       
            Direccion_individualizadaDAO direcIDAO = new Direccion_individualizadaDAO();
            List<Direccion_individualizada> listadirecI = direcIDAO.buscarDireccionIndividualizadaPorNombre(id);
    ...
    private void eliminarDireccionIndividualizada(int id) {
            Direccion_individualizadaDAO direcIDAO = new Direccion_individualizadaDAO();
            direcIDAO.eliminarDireccionIndividualizada(id);
    }
    ...
    private void initComponents() {
        ...
        visorDireccionIndividualizada = new javax.swing.JTable();
        ...
        jLabel1.setText("Direccion Individualizada");
        ...
        visorDireccionIndividualizada.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "Id_tesis", "Titulo_tesis", "Grado_tesis", "Fecha_inicio", "Fecha_fin", "Estado", "Es_CA", "No_ind_CA", "Institucion_trabajo", "Profesor_CURP"
            }
        ));
        jScrollPane1.setViewportView(visorDireccionIndividualizada);
    ...
    private void btnEliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEliminarMouseClicked
        ...
        List<Direccion_individualizada> direcI = direcIDAO.buscarDireccionIndividualizadaPorNombre(Integer.parseInt(txtDatoBusqueda.getText()));
        if (!direcI.isEmpty()) {
            int id= Integer.parseInt(txtDatoBusqueda.getText());
            eliminarDireccionIndividualizada(id);
        } else {
            JOptionPane.showMessageDialog(this, "No se encontró ningúna Direccion Individualizada");
        }
    }//GEN-LAST:event_btnEliminarMouseClicked

    private void btnInsertarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnInsertarMouseClicked
        idi.setLocationRelativeTo(null);
        idi.setVisible(true);
    ...
    private void btnBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnBuscarMouseClicked
        buscarDireccionIndividualizadaPorID(Integer.parseInt(txtDatoBusqueda.getText()));

        Direccion_individualizadaDAO direcIDAO = new Direccion_individualizadaDAO();

        List<Direccion_individualizada> direcI = direcIDAO.buscarDireccionIndividualizadaPorNombre(Integer.parseInt(txtDatoBusqueda.getText()));
        if (!direcI.isEmpty()) {
            Direccion_individualizada di = direcI.get(0); 
            adi.mostrarDatos(di);
        } else {
            JOptionPane.showMessageDialog(this, "No se encontró ningúna Direccion Individualizada");
        }
    ...
    private javax.swing.JTable visorDireccionIndividualizada;

 ...
 * @author anton
 */
public class GestionDatosLaborales extends javax.swing.JDialog {
    private InsertarDatosLaborales idl;
    private ActualizarDatosLaborales adl;

    /**
     * Creates new form GestionProfesor
     */
    public GestionDatosLaborales(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        idl=new InsertarDatosLaborales(this,true);
        adl=new ActualizarDatosLaborales(this,true);
       ...
       private void cargarDatosEnTabla (){
        try {
            Datos_laboralesDAO profesorDAO = new Datos_laboralesDAO();
            List<Datos_laborales> listaDatosL = profesorDAO.obtenerDatosLaborales();
            
            DefaultTableModel model = (DefaultTableModel) visorDatosLaborales.getModel();
            model.setRowCount(0); //Limpiar el modelo
            
            for(Datos_laborales datosL : listaDatosL){
                model.addRow(new Object[]{
                    datosL.getNo_profesor(),
                    datosL.getNombramiento_institucional(),
                    datosL.getDedicacion(),
                    datosL.getDependencia(),
                    datosL.getInicio_contrato(),
                    datosL.getFin_contrato(),
                    datosL.getEstado(),
                    datosL.getEmail_institucional()});
            }
    ...
    private void buscarDatosLaboralesPorID(int noProfesor) {
       
            Datos_laboralesDAO datosLDAO = new Datos_laboralesDAO();
            List<Datos_laborales> listadatosL = datosLDAO.buscarDatosLaboralesPorNombre(noProfesor);
    ...
    private void eliminarDatosLaborales(int id) {
            Datos_laboralesDAO datosLDAO = new Datos_laboralesDAO();
            datosLDAO.eliminarDatosLaborales(id);
    }
    ...
    private void initComponents() {
        ...
        visorDatosLaborales = new javax.swing.JTable();
        ...
        visorDatosLaborales.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "No_profesor", "Nombramiento_institucional", "Dedicacion", "Dependencia", "Inicio_contrato", "Fin_contrato", "Estado", "Email_institucional"
            }
        ));
        jScrollPane1.setViewportView(visorDatosLaborales);
    ...
    private void btnEliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEliminarMouseClicked
        ...
        List<Datos_laborales> datosL = datosLDAO.buscarDatosLaboralesPorNombre(Integer.parseInt(txtDatoBusqueda.getText()));
        if (!datosL.isEmpty()) {
            int id= Integer.parseInt(txtDatoBusqueda.getText());
            eliminarDatosLaborales(id);
        } else {
            JOptionPane.showMessageDialog(this, "No se encontró ningún Dato Laboral");
        }
    ...
    private void btnBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnBuscarMouseClicked
        buscarDatosLaboralesPorID(Integer.parseInt(txtDatoBusqueda.getText()));
        Datos_laboralesDAO datosLDAO = new Datos_laboralesDAO();

        List<Datos_laborales> datosL = datosLDAO.buscarDatosLaboralesPorNombre(Integer.parseInt(txtDatoBusqueda.getText()));
        if (!datosL.isEmpty()) {
            Datos_laborales dl = datosL.get(0); 
            adl.mostrarDatos(dl);
        } else {
            JOptionPane.showMessageDialog(this, "No se encontró ningún Dato Laboral");
        }
    ...
    private javax.swing.JTable visorDatosLaborales;
